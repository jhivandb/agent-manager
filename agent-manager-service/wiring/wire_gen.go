...
func InitializeAppParams(cfg *config.Config, db *gorm.DB, authProvider client.AuthProvider, secretProvider secretmanagersvc.Provider, gatewayApplier services.GatewayConfigApplier, agentThunderProvisioning services.AgentThunderProvisioningService) (*AppParams, error) {
	...
	a2AAgentCardServiceInterface := services.NewA2AAgentCardService(a2APublicationRepository, openChoreoClient)
	a2AAgentCardController := controllers.NewA2AAgentCardController(a2AAgentCardServiceInterface)
	...
	a2AAgentCardFetcher := ProvideA2AAgentCardFetcher()
	a2APublicationReconcilerService := services.NewA2APublicationReconcilerService(a2APublicationRepository, deploymentRepository, gatewayRepository, agentConfigRepository, openChoreoClient, a2AAgentCardFetcher, gatewayEventsService, logger)
	appParams := &AppParams{
